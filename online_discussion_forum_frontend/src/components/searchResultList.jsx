          ...
          <Card sx={{ display: 'flex', flexDirection: 'row' }} style={{
            ...
            <CardContent onClick={() => {
              ...
              <Stack alignItems={'center'} justifyContent={'flex-start'} flexDirection={'row'} bgcolor={'#E2E3E3'}>
                <Image height={'70px'} width={'70px'} preview={false} src={result.image !== '' ? `https://dycihub-api.vercel.app/images/${result.image}` : 'https://fakeimg.pl/200x100/?retina=1&text=こんにちは&font=noto'} style={{
                  objectFit: 'contain'
                }} />
