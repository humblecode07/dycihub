            ...
            <Box width={'1202px'}>
                ...
                {instructor && (
                    <Stack direction={'row'} alignItems={'center'} marginBottom={'50px'}>
                        <Avatar src={instructor.profile ? `https://dycihub-api.vercel.app/images/${instructor.profile}` : `https://picsum.photos/id/237/200/300`} sx={{
                            width: 160,
                            height: 160,
                            ...
                            {instructor?.students.map((student) => (
                                <Grid item xs={6} key={student._id}>
                                    <Stack flexDirection={'row'} alignItems="center" width={'100%'}>
                                        <Avatar src={`https://dycihub-api.vercel.app/images/${student.profile}`} style={{ width: 80, height: 80, backgroundColor: 'primary.main' }} sx={{ marginRight: '10px' }} />
